            ...
            <form action="/admin/document-types" method="POST" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <input
                        ...
                        placeholder="Contoh: Akta Lahir, Akta Nikah, Ijazah"
                    />
                    <p class="text-[10px] text-slate-400">Gunakan tanda koma (`,`) untuk menambahkan beberapa tipe dokumen sekaligus.</p>
                </div>
